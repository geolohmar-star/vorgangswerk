...
urlpatterns = [
    ...
    path("task/<int:task_pk>/signaturanfrage/", views.signaturanfrage_senden, name="signaturanfrage_senden"),
    path("task/<int:task_pk>/direkt-signatur/", views.direkt_signatur_speichern, name="direkt_signatur_speichern"),
